...
:: Set variables
set SCRIPT_DIR=%~dp0
set MINICONDA_URL=https://mirrors.tuna.tsinghua.edu.cn/anaconda/miniconda/Miniconda3-py312_24.9.2-0-Windows-x86_64.exe
...
pip install "%SCRIPT_DIR%\library\ta_lib-0.5.1-cp312-cp312-win_amd64.whl"
