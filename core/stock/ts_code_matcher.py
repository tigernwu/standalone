...
# UpdateTsCodeCache
# from core.stock.ts_code_builder import build_tushare_cache
# build_tushare_cache()
...
class TsCodeMatcher(StringMatcher):
    ...
    def __init__(self):
        ...
        df = pickle.load(open('./json/tushare_code_20241105.pickle', 'rb'))
        index_cache = f"./json/tushare_code_20241105_index_{index_column}_{result_column}.pickle"
