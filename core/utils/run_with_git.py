...
def run_task_with_git(task_function: Callable[[], Any], commit_message: str, output_dir: str = './'):
    # 配置日志记录
    logging.basicConfig(filename=f'./output/task_job.log', level=logging.INFO)
...
if __name__ == "__main__":
    from task.stock_recommend import run_once as stock_recommend_once
    
    run_task_with_git(stock_recommend_once, "Update stock recommendations", "./stock_recommend")
