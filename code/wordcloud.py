...
def preprocess_text(text):
    ...
    '支持', '行业', '推荐', '推进','主题', '逐步', '构建', '实施','项目','加强','提升','提高','推动','推出','推广','推进', '逐步', '构建', '实施','项目',
    ...
    ,'红色','蓝色','绿色','黄色','紫色','行动','情况','综合','集体','集团','商品','工程','日报','健全','东方','计划','组织','未来','成交','签订','公顷','公里',
    '控件','空间'
])
...
plt.close()
print(f"词云图已保存为 {wordcloud_file}")